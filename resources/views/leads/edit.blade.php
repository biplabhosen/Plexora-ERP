...
@section('content')
    <div class="d-flex flex-column flex-lg-row align-items-lg-center justify-content-between gap-3 mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Refine owner, stage, and context as this prospect moves through the pipeline.</p>
        </div>
        ...
        <div class="card-body p-4">
            <form action="{{ route('leads.update', $lead) }}" method="POST" class="row g-3">
                ...
                <div class="col-12 col-md-4">
                    ...
                    <input type="text" name="source" value="{{ old('source', $lead->source) }}" class="form-control @error('source') is-invalid @enderror">
                ...
                <div class="col-12 d-flex justify-content-end gap-2 pt-2">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="fa fa-check me-2"></i>Update Lead
                    </button>
                </div>
            </form>
        </div>
